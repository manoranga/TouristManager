...
public class LoginGuide extends AppCompatActivity {
    String url = "http://teampro.azurewebsites.net/api/TourGuide/Login";
    EditText userName;
    EditText password;
    Button btnRegister;
    Button btnLogin;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(jsonParams),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            int uId = response.getInt("guideId");
                            String email = response.getString("email");
                            String phoneNum = response.getString("discription");
                            String uname = response.getString("userName");
                            user = new User(uId, email, phoneNum, uname);
                        ...
                        Intent in = new Intent(getApplicationContext(), CabSelectActivity.class);
                        startActivity(in);
